        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                <div className="text-center max-w-4xl mx-auto">
                    <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-6">
                        AI_Powered <span className="text-red-600"> Bot</span>
                    </h1>
                    <p className="text-base sm:text-xl text-white mb-8 leading-relaxed max-w-3xl mx-auto">
                       Let our AI analyze charts or market text to identify patterns, generate precise entry, stop-loss, and take-profit levels, and provide smart trading insights to help you make better market decisions.
                    </p>
                ...
                <div className="mt-12 relative max-w-5xl mx-auto flex justify-center">
                    <img src={HERO_IMG} alt="Chat app ScreenShot" className="rounded-3xl shadow-lg  shadow-gray-300 " />
            </div>
            </div>
      </section>
    )
