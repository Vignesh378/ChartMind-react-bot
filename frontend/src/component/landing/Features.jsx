       ...
       <section id="features" className="py-20 lg:py-28 bg-[#100f0f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
                <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4"> ChartMind Where Charts Speak and AI Listens.</h2>
                <p className="text-xl text-white max-w-3xl mx-auto"> Everything you need to analyze your charts.</p>
